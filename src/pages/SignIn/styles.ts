...
export const Content = styled.div`
  ...
  /** Esse sinal de maior informa que quero estizar o "a" diretamente de dentro do meu content e não mais um nível ou o "a" seguinte
   dessa fora minha estilização afeta apenas o meu "a" que esta fora do form*/
  > a {
    color: #ff9000;
    display: block;
    margin-top: 24px;
